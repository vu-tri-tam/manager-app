...
export default function StickyHeadTable() {
    ...
    const rows = data && data?.map((res, idx) => {
        return createData(
            ...
            res?.endWork ? <p className='text-success'><CircleSharpIcon color='success' />Đã hoàn thành</p> : <p className='text-danger'><ErrorIcon color="error" />Chưa hoàn thành</p>,
...

                            {
                                ...
                                rows?.length > 0 ?
                                    ...
                                    rows?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
                                        ...
                                        >
                                        <TableCell align="center" colSpan={6}> Chưa có lịch sử</TableCell>
                                    </TableRow>
                            }
                        </TableBody>
                    </Table>
